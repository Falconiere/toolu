...
[ "$available_count" -eq 12 ] || fail "expected 12 available plugins, found $available_count"
...
[ "$installed_count" -eq 12 ] || fail "expected 12 installed plugins, found $installed_count"
...
[ "$session_start_count" -eq 15 ] || fail "expected 15 SessionStart commands, ran $session_start_count"
