...
Use [semantic judgments](../../workflows/semantic-judgments.md) for
step-to-requirement comparisons — Jev is mandatory on every task. Keep ledger
validation and the approval verdict grounded in the checks below.
