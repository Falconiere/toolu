...
Use [semantic judgments](../../workflows/semantic-judgments.md) when triaging
supplied evidence would change the next action, including during local review.
Reuse unchanged judgments; correctness still requires the real checks below.
