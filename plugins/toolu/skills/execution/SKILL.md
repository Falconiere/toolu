...
Use [semantic judgments](../../workflows/semantic-judgments.md) to triage
supplied evidence, including during local review — Jev is mandatory on every
task. Reuse unchanged judgments; correctness still requires the real checks below.
